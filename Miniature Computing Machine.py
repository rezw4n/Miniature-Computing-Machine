...
with st.beta_expander(label="About this website..."):
    st.markdown(
        ...
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;1. All the course titles and their information were collected from the official website.  
        &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;2. Want to contribute? Feel free to open a [pull request!](https://github.com/rezw4n/miniature-computing-machine/pulls)  
